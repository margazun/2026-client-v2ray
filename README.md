...
![v2rayn logo](img/v2rayn/v2rayn-logo-150x150.png)
...
![routing](img/v2rayn/v2rayn012-routing.png)

Нажмем кнопку **Импортировать правила**.

![routing](img/v2rayn/v2rayn013-routing-import.png)

Установим правила маршрутизации и нажмем кнопку **Подтвердить**.

![routing](img/v2rayn/v2rayn014-routing-set.png)
...
Запускаем *v2rayNG* и переходим в настройки, нажимая вверху слева три полоски (гамбургер).
...
* Определяем **IP** на [российском сайте](https://2ip.ru/) - должен быть определен как ip вашего провайдера, местоположение должно быть Россия.
* Определяем **IP** на [другом сайте](https://whoer.net/ru) - должен быть определен как ip вашего vds сервера, местоположение должно быть как локация вашего прокси-сервера.
